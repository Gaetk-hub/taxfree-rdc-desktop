...
// Dynamic Mobile App Button Component
function MobileAppButton({ onClick }: { onClick: () => void }) {
  ...
  if (platform === 'ios') {
    return (
      <button 
        onClick={onClick}
        className="group w-full flex items-center gap-4 px-5 py-4 bg-gradient-to-r from-gray-900 to-black hover:from-gray-800 hover:to-gray-900 backdrop-blur-sm rounded-2xl border border-white/20 transition-all shadow-lg hover:shadow-xl"
      >
        ...
        <div className="text-left flex-1">
          <span className="block text-xs text-white/60 font-medium">Bientôt disponible sur</span>
          <span className="block text-lg font-bold text-white">App Store</span>
        </div>
        <div className="px-3 py-1.5 bg-white/10 rounded-full">
          <span className="text-xs font-semibold text-white/80">2026</span>
        </div>
      </button>
    );
  }
  ...
  if (platform === 'android') {
    return (
      <button 
        onClick={onClick}
        className="group w-full flex items-center gap-4 px-5 py-4 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 backdrop-blur-sm rounded-2xl border border-white/20 transition-all shadow-lg hover:shadow-xl"
      >
        ...
        <div className="text-left flex-1">
          <span className="block text-xs text-white/70 font-medium">Bientôt disponible sur</span>
  ...
  // Desktop or Unknown - Show both options compact
  return (
    <div className="flex items-center gap-3">
      <button 
        onClick={onClick}
        className="group flex-1 flex items-center gap-3 px-4 py-3 bg-black/40 hover:bg-black/50 backdrop-blur-sm rounded-xl border border-white/10 hover:border-white/20 transition-all"
      >
        ...
        <div className="text-left">
          <span className="block text-[10px] text-white/50 uppercase tracking-wide">Bientôt</span>
      ...
      <button 
        onClick={onClick}
        className="group flex-1 flex items-center gap-3 px-4 py-3 bg-green-600/80 hover:bg-green-600 backdrop-blur-sm rounded-xl border border-white/10 hover:border-white/20 transition-all"
      >
        ...
        <div className="text-left">
          <span className="block text-[10px] text-white/60 uppercase tracking-wide">Bientôt</span>
      ...
      <div className="lg:hidden relative min-h-[100vh]">
        ...
        <div className="relative z-10 flex flex-col justify-end min-h-[100vh] px-6 pb-12 pt-24">
          ...
          <div className="space-y-6">
            ...
            {/* App Download Section - Dynamic based on device */}
            <div className="mt-6 pt-6 border-t border-white/10">
              <MobileAppButton onClick={() => setShowMobileAppModal(true)} />
            </div>
          </div>
        </div>
      </div>

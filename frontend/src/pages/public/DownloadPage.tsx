...
const platforms = {
  windows: {
    ...
    size: '~4 MB',
    downloadUrl: `${GITHUB_RELEASE_URL}/Tax.Free.RDC_1.0.5_x64-setup.exe`,
  },
  macos: {
    name: 'macOS',
    icon: '🍎',
    ...
    size: '~5 MB',
    downloadUrl: `${GITHUB_RELEASE_URL}/Tax.Free.RDC_1.0.5_aarch64.dmg`,
  },
  linux: {
    name: 'Linux',
    icon: '🐧',
    ...
    size: '~80 MB',
    downloadUrl: `${GITHUB_RELEASE_URL}/Tax.Free.RDC_1.0.5_amd64.AppImage`,
  },
};

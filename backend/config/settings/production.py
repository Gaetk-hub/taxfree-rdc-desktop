...
# Cloudinary storage for persistent file storage on Render
CLOUDINARY_STORAGE = {
...
# Frontend URL for activation links in emails
FRONTEND_URL = os.getenv('FRONTEND_URL', 'https://detaxerdc.vercel.app')
